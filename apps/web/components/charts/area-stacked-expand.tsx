...
export function ChartAreaStackedExpand() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Area Chart — Stacked Expand (100%)</CardTitle>
        <CardDescription>Share of traffic by channel</CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig} className="min-h-[220px] w-full">
          <AreaChart accessibilityLayer data={chartData} stackOffset="expand" margin={{ left: 12, right: 12 }}>
            ...
            <Area dataKey="referral" type="natural" fill="var(--color-referral)" fillOpacity={0.5} stroke="var(--color-referral)" stackId="a" />
            <Area dataKey="paid" type="natural" fill="var(--color-paid)" fillOpacity={0.5} stroke="var(--color-paid)" stackId="a" />
            <Area dataKey="organic" type="natural" fill="var(--color-organic)" fillOpacity={0.5} stroke="var(--color-organic)" stackId="a" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
